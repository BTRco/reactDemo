...
import {
  get,
  add,
} from "../../../actions/admin/BrandNameActions";
import classnames from "classnames";

class UpdateBrandName extends Component {
  constructor() {
    super();
  ...
  componentWillReceiveProps(nextProps) {
    ...
    const { id, name, isOld } = nextProps.brandName;
  ...
  onSubmit(e) {
    ...
    this.props.add(updatedBrandName, this.props.history);
  }

  componentDidMount() {
    const { brandNameId } = this.props.match.params;
    this.props.get(brandNameId);
  }
      ...
      <div className="container pb-5">
        ...
        <form className="form" onSubmit={this.onSubmit}>
          <div className="row">
            ...
            <div className="col">
              <Link to="/admin/brandName" className="btn btn-secondary float-right">
                Back
              </Link>
            </div>
            <div className="col">
...
const mapStateToProps = (state) => ({
  brandName: state.brandNameRed.brandName,
  errors: state.errors,
});
