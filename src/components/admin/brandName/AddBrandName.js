...
import { add } from "../../../actions/admin/BrandNameActions";
import classnames from "classnames";

class AddBrandName extends Component {
  constructor() {
    super();
    this.state = {
      name: "",
  ...
  onSubmit(e) {
    ...
    this.props.add(newBrandName, this.props.history);
  }
      ...
      <div className="container pb-5">
        ...
        <form className="form" onSubmit={this.onSubmit}>
          <div className="row">
            ...
            <div className="col">
              <Link to="/admin/brandType" className="btn btn-secondary float-right">
                Back
              </Link>
            </div>
            <div className="col">
...
export default connect(mapStateToProps, { add })(AddBrandName);
